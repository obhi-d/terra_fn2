...
FASTSIMD_BUILD_CLASS( FASTNOISE_CLASS( Clamp ) )
FASTSIMD_BUILD_CLASS( FASTNOISE_CLASS( Octaves ) )
FASTSIMD_BUILD_CLASS( FASTNOISE_CLASS( ConvertRGBA8 ) )
FASTSIMD_BUILD_CLASS( FASTNOISE_CLASS( ConvertRAW16 ) )
...
FASTSIMD_BUILD_CLASS( FASTNOISE_CLASS( StrataMask ) )
FASTSIMD_BUILD_CLASS( FASTNOISE_CLASS( GeneratorCache ) )
FASTSIMD_BUILD_CLASS( FASTNOISE_CLASS( EdgeFalloff ) )
FASTSIMD_BUILD_CLASS( FASTNOISE_CLASS( ApplyOnRange ) )
FASTSIMD_BUILD_CLASS( FASTNOISE_CLASS( CurveGen ) )

FASTSIMD_BUILD_CLASS( FASTNOISE_CLASS( PassThrough ) )
FASTSIMD_BUILD_CLASS( FASTNOISE_CLASS( ConvertRAW8 ) )

FASTSIMD_BUILD_CLASS( FASTNOISE_CLASS( GridRandomConstant ) )
